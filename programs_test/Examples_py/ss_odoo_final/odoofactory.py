...
class odooLibrary:
            ...
            if params is None:
                ...
                if user_id is None:
                    ...
                    if update_pwd is not None:
                        ...
                        email_notification(client_name, body = "Dear Customer <br><br> we are proudly welcome to You <br><br> Your Account has been created succesfully your login Credentials <b><br> user name : %s <br> Password : %s <br></b><br><br> Thanks & Regards<br>B2K Support Team"%(client_name, self.defaultpwd))
                    else:
    ...
    def sendFeedbackMail(self, params):
        try:  
            email_notification("postmaster@b2k.com.br", body="Hello  Postmaster </br></br> You have Received one New Feedback Message <br></br> Client Name :: %s <br> Client Company : %s <br> Customer mail-ID : %s <br> Customer Phone Number : %s <br> Message : %s  <br> </br> Thanks & Regards <br> B2K Support Team"%(params.get("custName"), params.get("custCompany"), params.get("custEmailAdd"), params.get("custPhone"), params.get("custmsg")))
        except Exception as er:
